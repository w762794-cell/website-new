...
## ចំណុចថ្មី៖ គាំទ្រ mp3 វែងជាង (~១៥-២០ នាទី)

Frontend ឥឡូវនេះ **បង្រួម audio ដោយស្វ័យប្រវត្តិនៅក្នុង browser** មុនផ្ញើទៅ server (ប្តូរទៅ mono
16kHz bitrate ទាប ដោយប្រើ Web Audio API + lamejs) ដូច្នេះឯកសារដើមអាចវែងជាងមុនច្រើន ដោយនៅតែ
ស្របតាមដែនកំណត់ upload ~4.4MB របស់ Vercel Free។ គុណភាពសំឡេងគ្រប់គ្រាន់សម្រាប់ស្តាប់ច្បាស់ និង
សម្រាប់ Whisper transcribe បានត្រឹមត្រូវ (Whisper ខ្លួនឯងក៏ដំណើរការនៅ 16kHz ដែរ ដូច្នេះមិនបាត់បង់
គុណភាព transcription ទេ)។ ការបង្រួមនេះអាចចំណាយពេលប៉ុន្មានវិនាទីទៅដល់មួយនាទី អាស្រ័យលើប្រវែង
ឯកសារដើម និងល្បឿនទូរស័ព្ទ។

**ដែនកំណត់**: ឯកសារវែងជាង ~20 នាទី អាចនៅតែធំពេកសម្រាប់ upload ទោះបីជាបង្រួមរួចហើយក៏ដោយ ហើយ
ការ decode ឯកសារវែងខ្លាំង (លើសពី 30-45 នាទី) អាចប្រើ memory ច្រើនលើទូរស័ព្ទ ធ្វើឲ្យ browser
យឺត ឬគាំង — សូមព្យាយាមកាត់ clip ខ្លីជាងនេះបើជួបបញ្ហា។
